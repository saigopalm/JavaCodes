...
public class Validator
{
    ...
    /** This method prompts the user to key in any string as input and returns the list of tokens in it
     * 
     */
     
    public static LinkedList<String> getStringTokens(String prompt)
    {
    Scanner sc = new Scanner(System.in);
    LinkedList<String> list = new LinkedList<String>();
        System.out.print(prompt);
        String input = sc.nextLine();//read user entry till the end of line
        
        sc = new Scanner(input);
        while(sc.hasNext()){//extracting tokens
            list.add(sc.next());
        }
